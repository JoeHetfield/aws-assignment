...
const definedMessages = defineMessages({
  ...
  additional: {
    ...
    description: '其他特性',
    defaultMessage: 'Additional Feature',
  },
  additionalContent: {
    id: `${prefix}.additionalContent`,
    description: '这个应用程序的默认语言为英语，你可以使用右上角的按钮来切换到中文。而且这个应用支持移动设备显示，但只是一个 App 骨架，业务功能没有在此移动版本上实现。（试一下吧，我觉得挺好看的）',
    defaultMessage: 'The default language of this App is English, you switch to Chinese with the button on the upper right coner. And this App can be viewed on mobile phone, but just a App skeleton, no busines function avaliable. (Try it out, I think it\'s looking good.)',
  },
  greeting: {
    id: `${prefix}.greeting`,
